...
const defaultWordle: WordleContextInterface = {
  guesses: [],
  currentGuess: "",
  solution: "",
  coloredGuesses: [],
...
const wordleCtx = createContext<WordleContextInterface>(defaultWordle);
const defaultKeyboard = () =>
  "abcdefghijklmnopqrstuvwxyz"
    .split("")
    .map((letter) => ({ letter, color: colors.white }));

export const WordleProvider = ({ children }: { children: JSX.Element }) => {
...
export const useWordle = () => {
  const value = useContext(wordleCtx);
  return value;
};
